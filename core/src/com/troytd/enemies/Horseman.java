...
public class Horseman extends Enemy {
     ...
     * @param map
     */
    public Horseman(byte line, TroyTD game, Vector2 position, Vector2 distortion, Vector2[] path, Map map,
                    Stage stage) {
        super(line, game, position, game.assetManager.get("enemies/Horseman.png", Texture.class), distortion,
              path, map, stage);
    }
}
