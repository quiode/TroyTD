...
public class Trojan_Horse extends Enemy {
     ...
     * @param map
     */
    public Trojan_Horse(byte line, TroyTD game, Vector2 position, Vector2 distortion, Vector2[] path, Map map,
                        Stage stage) {
        super(line, game, position, game.assetManager.get("enemies/Trojan_Horse.png", Texture.class),
              distortion, path, map, stage);
    }
}
